...
settings-text =
    ...
    Вмикай або вимикай сповіщення Price Bird. Вимкнення скасовує заплановані доставки в Telegram. Алерти продовжують перевірятися. Постав окремі алерти на паузу через /alerts.
settings-text-connections =
    Налаштування доставки

    Обери, куди надсилати всі твої алерти. Увімкни Price Bird, підключений застосунок або обидва варіанти. Вимкнення напрямку скасовує його заплановані доставки. Алерти продовжують перевірятися. Постав окремі алерти на паузу через /alerts.
